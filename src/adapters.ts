...
const buildDefaultPrompt = (
  ...
  const promptParts = [
    ...
    "Focus on what needs to change and the expected behavior, not implementation details.",
    "Describe requirements and functional changes using implementation-agnostic language readable by any engineer.",
    "",
    "Return JSON only.",
    "Format:",
